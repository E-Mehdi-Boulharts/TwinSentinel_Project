...
OUTPUT_DIR = "/home/mehdi/VANET_Project/Docker_files"
...
def main():
    ...
    # Save files
    png_path = os.path.join(OUTPUT_DIR, "runs_roc_pr_comparison.png")
    pdf_path = os.path.join(OUTPUT_DIR, "runs_roc_pr_comparison.pdf")
